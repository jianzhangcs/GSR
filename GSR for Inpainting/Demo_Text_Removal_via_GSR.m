...
for ImgNo = 1
    for ratio_num = 5
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % Save Images
        img_inpait_name = strcat(OrgName,'_ratio',num2str(ratio),'_',num2str(csnr(x,x_final,0,0)),'_text_GSR.png');
        img_inpait_plot_name = strcat(OrgName,'_ratio',num2str(ratio),'_',num2str(csnr(x,x_final,0,0)),'_text_plot_GSR.png');
        img_missing_name = strcat(OrgName,'_ratio',num2str(ratio),'_',num2str(csnr(x,y,0,0)),'_text_missing.png');
